...
const caseStudy: CaseStudy = {
  ...
  duration: "Reference programme: 7 months to production",
  role: "Solution Architect (case study author)",
  client: "European payment service provider",
  clientNote: "~4,000 merchants · card-not-present",
  githubUrl: "",
  liveDemoUrl: "",
  ...
  costOptimization: {
    ...
    model: [
      ...
      { k: "Target band", v: "Below 0.06% — the threshold for the exemption at the higher value tier" },
  ...
  kpis: [
    {
      ...
      baseline: "0.11%",
      target: "< 0.045%",
      why: "The target sits deliberately below the 0.06% threshold. Running at the threshold is the same as planning to cross it.",
    },
    {
      category: "Commercial",
